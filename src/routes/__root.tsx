...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Native Lens helps people understand content in context. Click any subtitle sentence in a real video and instantly see translations, meaning, and expression notes." },
      { name: "author", content: "Native Lens" },
      { property: "og:title", content: "Native Lens — Understand content in context" },
      { property: "og:description", content: "Click any subtitle sentence in a real video and instantly see translations, meaning, and expressions in context." },
      { property: "og:type", content: "website" },
      { name: "twitter:card", content: "summary" },
      { name: "twitter:site", content: "@Native Lens" },
      { name: "twitter:title", content: "Native Lens — Understand content in context" },
