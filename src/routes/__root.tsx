...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Clario helps people understand content in context. Click any subtitle sentence in a real video and instantly see translations, meaning, and expression notes." },
      { name: "author", content: "Clario" },
      { property: "og:title", content: "Clario — Understand content in context" },
      ...
      { name: "twitter:site", content: "@Clario" },
      { name: "twitter:title", content: "Clario — Understand content in context" },
