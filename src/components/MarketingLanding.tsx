  ...
  return (
    ...
    >
      ...
      <div className="relative z-10">
        <a
          href="/today"
          onClick={() => track("today_banner_clicked", { source: "landing_top" })}
          className="group block border-b border-orange-200/70 bg-gradient-to-r from-orange-50 via-amber-50 to-orange-50 text-center"
        >
